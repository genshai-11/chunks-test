                ...
                <div className="mt-4 pt-3 border-t border-slate-100 space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    {[
                      ...
                      const isActive = Boolean(matchedVer && (matchedVer.isActive || activeVersion?.id === matchedVer.id));
                      const isOptPlaying = Boolean(matchedVer && playingKey === matchedVer.id && playbackStatus.isPlaying);
