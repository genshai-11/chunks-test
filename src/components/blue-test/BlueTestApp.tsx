...
import { BlueTestSetup } from './BlueTestSetup';
  ...
  return (
    <div className="h-full min-h-0 flex flex-row bg-slate-950 text-slate-100 overflow-hidden">
      ...
      >
        ...
        {!isNavCollapsed && (
          <div className="px-3 py-2 bg-slate-950/40 border-b border-slate-800/80 text-[11px] text-slate-400">
      ...
      <div className="flex-1 min-h-0 min-w-0 overflow-y-auto p-3 sm:p-5 lg:p-6">
        {currentSubView === 'setup' && (
          <BlueTestSetup
            ...
            onStartTest={() => setCurrentSubView('room')}
